...
This repository is a personal recreation project inspired by Claude Code.

- It is not an official Claude Code implementation.
- It focuses on reproducing core runtime ideas in a minimal, inspectable codebase.
- Feature coverage is partial and intentionally iterative.
